...
public class Saxon97HEPlugin implements TransformerPlugin{

    private static final String VERSION = "saxon-9.7.0.21-he";
    ...
    }, Saxon97HEPlugin.class.getClassLoader());
    ...
    public Transformer newTransformer(Source source, ByteArrayOutputStream errors) throws TransformerConfigurationException {
        ...
        try {
            ...
            Object conf = TransformerFactoryClass.getMethod("getConfiguration").invoke(transformerFactory);; //transformerFactory.getAttribute((String)FeatureKeysClass.getField("CONFIGURATION").get(null));//ProcessorClass.getMethod("getUnderlyingConfiguration").invoke(proc);  //transformerFactory.getAttribute((String)FeatureKeysClass.getField("CONFIGURATION").get(null));
